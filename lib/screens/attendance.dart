                      ...
                      SizedBox(
                        ...
                        child: GridView.builder(
                          ...
                          gridDelegate:
                            ...
                            crossAxisCount: 10, // Number of avatars in each row
                            ...
                            return InkWell(
                                onTap: () async {
                                  ...
                                  if (myCubit.usersList[listViewIndex]
                                      ...
                                      true) {
                                    var updatedValue = myCubit.attendanceHelper(
                                        index,
                                        false,
                                        myCubit.usersList[listViewIndex]
                                            .attendanceList);
                                    await FirebaseFirestore.instance
                                        .collection('${myCubit.email}')
                                        .doc(myCubit
                                            .usersList[listViewIndex].docId)
                                        .update({
                                ...
                                child: myCubit.usersList[listViewIndex]
                                        .attendanceList[index]
                                    ? CircleAvatar(
                                        backgroundColor:
